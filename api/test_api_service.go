...
// KlineWebSocoketInqReq : Kline조회요청
func KlineWebSocketInqReq(c *gin.Context) {

	// 요청 정보
	reqInfo := bsml.WebSocketKlineRequest{}
	...
	//
	resultFlag, errMsg, resp := KlineWebSocoketInq(&reqInfo)
